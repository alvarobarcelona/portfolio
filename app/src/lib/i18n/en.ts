export const en = {
  ...
  about: {
    ...
    highlights: {
      fullstack: {
        ...
        desc: "Building end-to-end solutions using React 19, TypeScript, Node.js and modern databases.",
      },
      business: {
        title: "Business Mindset",
        desc: "About 10 years in logistics & logistics management. I build software that solves real business problems.",
      },
      ai: {
        title: "AI-Enhanced Workflow",
        desc: "Leveraging AI as an external skeleton to code faster, prototype rapidly, and focus on architecture.",
      },
      agile: {
        title: "Agile & Teamwork",
        desc: "Proven track record in agile environments, cross-functional teams.",
      },
    },
  },
  skills: {
  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Supporting project management and business development. Design or buy your dreamed sunglasses",
        responsibilities: [
  ...
  projects: {
    ...
    featured: "Most complete project",
    items: {
      portfolio: {
